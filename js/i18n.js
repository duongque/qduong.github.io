...
window.I18N = {
  en: {
    ...
    edu: {
      ...
      nuclear_diploma: "MSc — Advanced Nuclear Physics",
      nuclear: "Advanced nuclear physics - Plasma physics - Nuclear fusion.",
      phelma_diploma: "Engineering Degree — Nuclear Engineering & Physics",
    ...
    events: {
      ...
      cas_desc: "11-day intensive course organised by the CERN Accelerator School (CAS) in collaboration with Riga Technical University, covering medical applications of particle accelerators.",
  ...
  fr: {
    ...
    edu: {
      phd_diploma: "Doctorat — Physique des Acclérateurs",
      phd_thesis: "<em>Thèse :</em> Étude du nuage d'électrons dans le LHC du CERN avec le Vacuum Pilot Sector.",
      juas_diploma: "Master — Physique & Technologies des Accélérateurs",
      ...
      nuclear_diploma: "Master — Physique Nulcéaire Avancée",
      nuclear: "Physique nucléaire avancée - Physique des plasmas - Fusion nucléaire.",
      phelma_diploma: "Diplôme d'ingénieur — Physique & Ingénierie Nucléaire",
    ...
    events: {
      ...
      cas_desc: "11 jours de formation intensive organisée par la CERN Accelerator School (CAS) en collaboration avec l'Université Technique de Riga, couvrant les applications médicales des accélérateurs de particules.",
      cas_link_name: "Topical course on Medical Accelerators, 15-26 June 2026, Jurmala, Latvia",
      cas_link_src: "indico.cern.ch",
