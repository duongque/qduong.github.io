...
window.I18N = {
  en: {
    ...
    pub: {
      ...
      placeholder: "Article — to fill",
      placeholder_title: "Article title — to fill",
      placeholder_journal: "Journal name",
      placeholder_abstract: "Abstract — to fill.",
  ...
  fr: {
    ...
    pub: {
      ...
      placeholder: "Article — à compléter",
      placeholder_title: "Titre de l'article — à compléter",
      placeholder_journal: "Nom du journal",
      placeholder_abstract: "Résumé — à compléter.",
